...
public class CourseControllerTest {
	...
	CourseEntity course = new CourseEntity(401,"java","java fundamentals by abc university",499.99);
	...
	CourseEntity course = new CourseEntity(401,"java","java fundamentals by abc university",499.99);
	Mockito.when(courseDAOInterface.save(course)).thenReturn(course);	
	CourseEntity courseActual1 = courseService.courseUpdateService(course);		
		assertEquals( course.getCid(), courseActual1.getCid());
	}
	...
	public void getAllCourses() { 
		...
		CourseEntity course2 = new CourseEntity(403,"c","c basic and advance cocepts",599.99);	
		...
		List<CourseEntity> actualCourseList = courseService.getAllCourses();
		assertEquals( courselist.size(), actualCourseList.size());
